...
var _unexpectedMagicpen = require('unexpected-magicpen');

var _unexpectedMagicpen2 = _interopRequireDefault(_unexpectedMagicpen);
...
var expect = _unexpected2['default'].clone().use(_unexpectedMagicpen2['default']).use(_magicpenPrism2['default']);
