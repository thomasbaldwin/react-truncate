...
describe('diff', function () {
    ...
    describe('error modes', function () {
        it('does not change the errorMode from default when diffing', function () {
            ...
            _diff2['default'].diffElements(_mockEntities.TestActualAdapter, _mockEntities.TestExpectedAdapter, (0, _mockEntities.createActual)({ name: 'SomeElement', attribs: { foo: 'bar' } }), (0, _mockEntities.createExpected)({ name: 'SomeElement', attribs: { foo: 'bar' } }), expect, {});
